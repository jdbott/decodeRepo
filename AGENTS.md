...
Guidance for Codex when working in this repository. This is an **FTC (FIRST Tech Challenge)** robot codebase for the **DECODE** season, built on **FTC SDK 11.1.0** with **Pedro Pathing** for autonomous path following.
