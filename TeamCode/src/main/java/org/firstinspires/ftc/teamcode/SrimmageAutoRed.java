...
public class SrimmageAutoRed extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(35.791+72, 135.000, Math.toRadians(90)));
        ...
        switch (pathState) {
            case 0:
                ...
                Path toShoot1 = new Path(new BezierLine(
                        ...
                        new Pose(144-46.465, 97.116))
                );
                toShoot1.setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(125-75), 0.8);
            ...
            case 5:
                ...
                forward1.setConstantHeadingInterpolation(Math.toRadians(0));
            ...
            case 61:
                if (pathTimer.getElapsedTimeSeconds() > 0.2) {
                    ...
                    forward2.setConstantHeadingInterpolation(Math.toRadians(0));
            ...
            case 71:
                if (pathTimer.getElapsedTimeSeconds() > 0.2) {
                    ...
                    forward3.setConstantHeadingInterpolation(Math.toRadians(0));
            ...
            case 9:
                ...
                Path toShootAgain = new Path(new BezierLine(
                        new Pose(follower.getPose().getX(), follower.getPose().getY()),
                        new Pose(144-46.465, 97.116) // same shoot point
                ));
                toShootAgain.setLinearHeadingInterpolation(
                        follower.getPose().getHeading(),
                        Math.toRadians(125-75) // same target heading as before
                );
            ...
            case 11:
                ...
                Path toLowerLine = new Path(new BezierLine(
                        new Pose(follower.getPose().getX(), follower.getPose().getY()),
                        new Pose(144-47.5, 89-24)
                ));
                toLowerLine.setConstantHeadingInterpolation(Math.toRadians(0));
