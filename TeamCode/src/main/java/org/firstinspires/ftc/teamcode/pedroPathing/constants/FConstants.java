...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 5.36599774;

        FollowerConstants.xMovement = 67.3772;
        FollowerConstants.yMovement = 55.2767;

        FollowerConstants.forwardZeroPowerAcceleration = -37.5226;
        FollowerConstants.lateralZeroPowerAcceleration = -50.9753;
        ...
        FollowerConstants.drivePIDFFeedForward = 0.2;
        FollowerConstants.secondaryDrivePIDFFeedForward = 0;
        FollowerConstants.drivePIDFSwitch = 8;
