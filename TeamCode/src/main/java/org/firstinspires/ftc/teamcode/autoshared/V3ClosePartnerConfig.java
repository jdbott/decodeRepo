...
/**
 * Single source of truth for V3ClosePartner's tunables, path geometry, and the distance→shot
 * lookup table (BLUE-NATIVE). Read by both the real opmode {@code autos.V3ClosePartner} and the
 * simulator copy {@code autosim.autos.V3ClosePartnerSim}.
 *
 * <p><b>Must stay plain Java</b> — no Pedro/Android imports (see {@link V3FarAutoConfig}).
 */
public final class V3ClosePartnerConfig {
    private V3ClosePartnerConfig() {}
    ...
    // Middle line cycle.
    public static final double L2_C1X = 48.0, L2_C1Y = 67.0;
    public static final double L2_C2X = 40.0, L2_C2Y = 63.0;
    public static final double L2_ENDX = 12.5, L2_ENDY = 62.0;
    ...
    public static final double RG2_C1X = 42.0, RG2_C1Y = 62.0;   // return-from-gate cycles 2/3

    // Higher-Y closer line.
    public static final double FP_C1X = 40.0, FP_C1Y = 84.0;
    public static final double FP_ENDX = 20.0, FP_ENDY = 84.0;

    // ===== Constant/linear interpolation headings (deg, BLUE-NATIVE) =====
    ...
    public static final double WAIT_AT_GATE_1_SEC = 0.1;
    public static final double GATE_INTAKE_1_SEC = 1.5;
    public static final double WAIT_AT_GATE_2_SEC = 0.25;
    public static final double GATE_INTAKE_2_SEC = 1.3;
    public static final double WAIT_AT_GATE_3_SEC = 0.25;
    public static final double GATE_INTAKE_3_SEC = 1.3;
