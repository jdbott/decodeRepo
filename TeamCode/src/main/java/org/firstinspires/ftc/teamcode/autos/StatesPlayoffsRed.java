...
// -----------------------------
    private static final double TURRET_TARGET_X = 144-6;
    ...
    @Override
    public void start() {
        flywheelASG.setTargetVelocity(303 + 7);
        setPathState(0);
    }
        ...
        switch (pathState) {
            ...
            case 3: {
                Path toLine2 = new Path(new BezierCurve(
                        ...
                        new Pose(144-40, 84 - 23),
                        new Pose(144-15, 84 - 24))
                );
            ...
            case 51: {
                ...
                toShoot2.setConstantHeadingInterpolation(Math.toRadians(15));
                gantry.moveGantryToPos("back");
                toShoot2.setBrakingStrength(1);
                follower.followPath(toShoot2, true);
                setPathState(6);
...
//                );
            ...
            case 9: {
                if (follower.getCurrentTValue() > 0.5) {
                    toGateIntake.setConstantHeadingInterpolation(Math.toRadians(20));
                }
                if (!follower.isBusy()) {
