...
public class BlueQ3AutoSorted extends OpMode {
    ...
    private void autoPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                ...
                toLine1.setLinearHeadingInterpolation(follower.getPose().getHeading(), Math.toRadians(180), 0.4);
                follower.followPath(toLine1, false);
                intake.intakeIn();
                setPathState(3);
                break;
            ...
            case 31:
                Path empty = new Path(new BezierCurve(
                        new Pose(follower.getPose().getX(), follower.getPose().getY()),
                        new Pose(40, 75),
                        new Pose(20, 72))
                );
                empty.setConstantHeadingInterpolation(Math.toRadians(180));
                follower.followPath(empty, true);
                setPathState(32);
                break;
