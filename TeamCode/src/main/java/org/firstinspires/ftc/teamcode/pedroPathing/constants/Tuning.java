...
import static org.firstinspires.ftc.teamcode.pedroPathing.constants.Tuning.*;
...
class LocalizationTest extends OpMode {
    ...
    public void loop() {
        ...
        Tuning.telemetryM.debug("x:" + follower.getPose().getX());
        Tuning.telemetryM.debug("y:" + follower.getPose().getY());
        Tuning.telemetryM.debug("heading:" + follower.getPose().getHeading());
        Tuning.telemetryM.debug("total heading:" + follower.getTotalHeading());
        Tuning.telemetryM.update(telemetry);
